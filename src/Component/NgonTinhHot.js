...
class NgonTinhHot extends Component {
    constructor(props) {
        super(props);
        this.state = {
          error: null,
      ...
      componentDidMount() {
        fetch("https://m-api.iread.vn/api/book/getBooks?catId=2&page=1&sort=4&size=5")
          .then(res => res.json())
          .then(
            (result) => {
              this.setState({
      ...
      return <div>Loading...</div>;
        ...
        return (
            ...
            <div className="block block-inverse block-ranking">
                ...
                <h2 className="title"> <i className="truyencv-icon icon-fire" /> Truyện Ngôn Tình Hot </h2>
                </div>
